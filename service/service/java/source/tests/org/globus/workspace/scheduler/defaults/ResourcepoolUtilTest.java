...
public class ResourcepoolUtilTest extends NimbusDatabaseTestCase {
    ...
    private static void populateDB() throws WorkspaceDatabaseException {
        entries.put("hostA", new ResourcepoolEntry("testrp", "hostA", 1000, 1000, "netC"));
        entries.put("hostB", new ResourcepoolEntry("testrp", "hostB", 1000, 100, "netB"));
        entries.put("hostC", new ResourcepoolEntry("testrp", "hostC", 1000, 900, "netA,netB"));
        entries.put("hostD", new ResourcepoolEntry("testrp", "hostD", 1000, 100, "*"));
        entries.put("hostE", new ResourcepoolEntry("testrp", "hostE", 1000, 0, "*"));
        entries.put("hostF", new ResourcepoolEntry("testrp", "hostF", 1000, 800, "netA"));
        entries.put("hostG", new ResourcepoolEntry("testrp", "hostG", 1000, 900, "netB"));
        entries.put("hostH", new ResourcepoolEntry("testrp", "hostH", 1000, 300, "netA,netB,netC"));
    ...
    public void compareMethodsGreedy() throws Exception{
        String hostNorm = ResourcepoolUtil.getResourcepoolEntry(200, new String[0], adapter, lagerImpl, 1, true);
        ResourcepoolUtil.retireMem(hostNorm, 200, adapter, lagerImpl.eventLog, lagerImpl.traceLog, 1);
        
        String hostImpr = ResourcepoolUtil.getResourcepoolEntry(200, new String[0], adapter, lagerImpl, 1, true);
    ...
    public void compareMethodsRoundRobin() throws Exception{
        String hostNorm = ResourcepoolUtil.getResourcepoolEntry(200, new String[0], adapter, lagerImpl, 1, false);
        ResourcepoolUtil.retireMem(hostNorm, 200, adapter, lagerImpl.eventLog, lagerImpl.traceLog, 1);
        
        String hostImpr = ResourcepoolUtil.getResourcePoolEntryImproved(200, new String[0], adapter, lagerImpl, 1, false);
        ResourcepoolUtil.retireMem(hostImpr, 200, adapter, lagerImpl.eventLog, lagerImpl.traceLog, 1);
    ...
    public void compareMethodsAssociationsGreedy() throws Exception{
        ...
        String hostNorm = ResourcepoolUtil.getResourcepoolEntry(100, neededAssociations, adapter, lagerImpl, 1, true);
        ResourcepoolUtil.retireMem(hostNorm, 100, adapter, lagerImpl.eventLog, lagerImpl.traceLog, 1);
        
        String hostImpr = ResourcepoolUtil.getResourcePoolEntryImproved(100, neededAssociations, adapter, lagerImpl, 1, true);
    ...
    public void compareMethodsAssociationsRoundRobin() throws Exception{
        ...
        String hostNorm = ResourcepoolUtil.getResourcepoolEntry(200, neededAssociations, adapter, lagerImpl, 1, false);
        ResourcepoolUtil.retireMem(hostNorm, 200, adapter, lagerImpl.eventLog, lagerImpl.traceLog, 1);
        
        String hostImpr = ResourcepoolUtil.getResourcePoolEntryImproved(200, neededAssociations, adapter, lagerImpl, 1, false);
        ResourcepoolUtil.retireMem(hostImpr, 200, adapter, lagerImpl.eventLog, lagerImpl.traceLog, 1);
